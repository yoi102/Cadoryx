...
这些是完整接入门禁，不能整体视为已通过。2026-09-12 M1-Q 已验证固定英寸/米源、旋转共享实例、整体/面颜色显示、12 次浮动/重新停靠/关闭重开与捕获丢失；完整 PMI/面样式导出、子拓扑选择、真实混合 DPI/RDP 和长期资源验证仍未完成。证据与复现方法见 [交换与视口验收](EXCHANGE_AND_VIEWPORT.md)。
